...
public class RegistryTest {
     ...
     */
    @Test
    public void shouldReturnValidWhenPersonIsEligibleAndUnique() throws Exception {
        // Arrange
     ...
     */
    @Test
    public void shouldReturnDuplicatedWhenDocumentAlreadyExists() throws Exception {
        // Arrange
        Person p1 = new Person("Ana", 100, 30, Gender.FEMALE, true);
    ...
    /**
     * Caso de prueba:
     * <p>Una persona menor de edad debe ser rechazada y no persistida.</p>
     */
    @Test
    public void shouldReturnUnderageWhenPersonAgeIsBelow18() throws Exception {
        // Arrange
        Person underage = new Person("Luis", 200, 17, Gender.MALE, true);
    ...
    /**
     * Caso de prueba:
     * <p>Una persona fallecida debe ser rechazada y no persistida.</p>
     */
    @Test
    public void shouldReturnDeadWhenPersonIsNotAlive() throws Exception {
        // Arrange
        Person deceased = new Person("Carlos", 300, 45, Gender.MALE, false);
